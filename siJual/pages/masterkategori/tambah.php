...
if(isset($_POST['simpan'])){
    ...
    $sql = "SELECT * FROM kategori WHERE nama='$nama'";
    $result = mysqli_query($koneksi,$sql);
    $jumlah = mysqli_num_rows($result);
    if($jumlah>0){
      $error = "Nama Kategori sudah pernah diinput ke database";
    }else{
      //siapkan kueri insert
      $sql2 = "insert into kategori(nama,created_at,created_by) VALUES('$nama','created_at','$created_by')";
