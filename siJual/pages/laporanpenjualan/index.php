...
<div id='divform'>
  <form class="form-horizontal" role="form" action="" method="post" id='form1' onsubmit="return cekdata()">
   <div class="form-group">
	    ...
	    <div class="col-sm-5">
	      <input type="date" class="form-control" id="tglawal" name="tglawal" placeholder="Tanggal Awal" required autofocus >
	    </div>
	  </div>
	   ...
	   <div class="form-group">
	    ...
	    <div class="col-sm-5">
	      <input type="date" class="form-control" id="tglakhir" name="tglakhir" placeholder="Tanggal Akhir" required >
	    </div>
	  </div>
